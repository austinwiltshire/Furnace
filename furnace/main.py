...
#    return None
    ...
    #stocks_perf = furnace.performance.fire_furnace(strategy.buy_and_hold_stocks(asset_factory.restricted_to(["SPY"]), begin, end), begin, end)


    #stocks_perf.growth_by(datetime.datetime(2003, 1, 2))
    #stocks_perf.growth_by(datetime.datetime(2004, 2, 2))
    #stocks_perf.growth_by(datetime.datetime(2005, 1, 3))
    #stocks_perf.growth_by(datetime.datetime(2012, 12, 31))
#
    ...
    #vol = stocks_perf.volatility()
    #growth = stocks_perf.growth_by(datetime.datetime(2004,1,6))
